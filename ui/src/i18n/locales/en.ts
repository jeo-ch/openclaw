...
export const en: TranslationMap = {
  ...
  mcpServers: {
    ...
    targetPlaceholder: "https://mcp.example.com/mcp  ·  npx some-mcp-server",
  ...
  chat: {
    messages: {
      ...
      contextPercent: "{pct}% ctx",
      cacheRead: "R",
      cacheWrite: "W",
      jsonBadge: "JSON",
      duplicatesCollapsed: "{count} duplicate messages collapsed",
